(() => {
  ...
  const U = {
      attachEvents: function () {
        ...
        (e.onTouchStart = j.bind(e)),
          ...
          (e.onClick = V.bind(e)),
          i.touch && !R && (t.addEventListener("touchstart", Y), (R = !0)),
          X(e, "on");
      },
  ...
  function ae({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function p() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(r), (e.pagination.bullets = n.find(re(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((r = t.renderFraction
    ...
    function u() {
      ...
      0 !== s.length &&
        (e.params.uniqueNavElements &&
          ...
          ((s = e.$el.find(t.el)),
          s.length > 1 &&
            (s = s.filter((t) => y(t).parents(".swiper")[0] === e.el))),
        ...
        t.clickable &&
          s.on("click", re(t.bulletClass), function (t) {
            t.preventDefault();
            let s = y(this).index() * e.params.slidesPerGroup;
  ...
  const pe = document.querySelector(".footer__totop"),
    ue = document.querySelector(".header").scrollIntoView;
  pe.addEventListener("click", function (e) {
    console.log("weedw"),
      window.scrollTo({ top: ue, left: 0, behavior: "smooth" });
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
